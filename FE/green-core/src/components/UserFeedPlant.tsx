					...
					userPlantList.length == 0 ? (
						...
						<div className="flex flex-row space-x-4 items-center mx-4">
							{userPlantPage == 0 ? (
								...
								<span className="material-symbols-outlined cursor-pointer" onClick={prevUserPlantListPage} style={{ fontSize: '1rem' }}>
									arrow_back_ios
								</span>
							)}
							...
							{userPlantPage >= Math.ceil(Number(userPlantListTotalCount) / Number(userPlantSize)) - 1 ? (
								...
								<span className="material-symbols-outlined cursor-pointer" onClick={nextUserPlantListPage} style={{ fontSize: '1rem' }}>
									arrow_forward_ios
								</span>
							)}
						</div>

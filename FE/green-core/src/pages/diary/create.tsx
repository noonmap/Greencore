    ...
    <AppLayout>
      <div className={`overflow-auto flex-1 mx-auto py-6 px-10 h-full`}>
        <div className='flex items-center mb-10'>
          ...
          <span className={`${styles.title} py-1`}>일지 생성</span>
        </div>
        ...
        <div className='flex mb-7'>
            ...
            <label htmlFor='image'>
              {preview ? (
                ...
                <div className={`${styles.inputImage}`}>
                  ...
                  <span style={{ color: 'var(--title-light-color', fontSize: '1rem' }}>일지의 사진을 추가해주세요!</span>
                </div>
              )}
            </label>
            <input
          ...
          <div className='flex-1 flex flex-col ml-4 justify-evenly'>
            {/* 관찰한 식물 선택 */}
            <div>
              <div className={`${styles.label}`}>관찰한 식물 선택</div>
              <select {...register('diarysetId')} defaultValue={getValues('diarysetId')} className={`w-full text-md ${styles.inputBox}`}>
            ...
            <div>
              ...
              <input
                ...
                className={`w-full text-md ${styles.inputBox}`}
              />
            </div>
          </div>
        </div>
        ...
        <div className={`w-full`}>
          ...
          <div className={`${styles.tagBox}`}>
            {tagList.map((tagItem, index) => {
              return (
                <div key={index} className={`${styles.tagComponent} flex justify-center items-center`}>
        ...
        <div className='flex mt-16'>
          ...
          <AppButton text='일지 생성' handleClick={handleCreateDiary} className={`flex-1 ${styles.btn}`} />
        </div>
      </div>
    </AppLayout>
  );

														...
														<div>
															<div
																...
																<img
																	...
																	style={{
																		display: isLoadingErrorAtTopDiarySet[index] ? 'none' : 'block',
																		width: '150px',
																		height: '150px'
																	}}
																/>
									...
									<div>
										...
										<div className={`flex justify-around`}>
											{samePlantUserList?.map((samPlantUser, index) => (
												<div key={samPlantUser.nickname} className={`overflow-hidden rounded-full`} style={{ boxShadow: 'var(--box-shadow)' }}>
